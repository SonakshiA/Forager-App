...
// TODO: pass a ForageableDao value as a parameter to the view model constructor- done
class ForageableViewModel(private val forageableDao: ForageableDao): ViewModel() {
    ...
    val allForageables : LiveData<List<Forageable>> = forageableDao.getItems().asLiveData()
    ...
    fun retrieveForageable(id:Long) : LiveData<Forageable>{
        return forageableDao.getItem(id).asLiveData()
    }
